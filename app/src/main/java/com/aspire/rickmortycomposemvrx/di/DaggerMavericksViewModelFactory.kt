...
import com.aspire.rickmortycomposemvrx.appComponent
 ...
 *
 *   @AssistedFactory
 *   interface Factory : com.aspire.rickmortycomposemvrx.di.AssistedViewModelFactory<MyViewModel, MyState> {
 *     ...
 *   }
 *
 *   companion object : MavericksViewModelFactory<MyViewModel, MyState> by com.aspire.rickmortycomposemvrx.di.daggerMavericksViewModelFactory()
 * }
 */
 ...
 *
 * This class accesses the map of [com.aspire.rickmortycomposemvrx.di.AssistedViewModelFactory]s from [AppComponent] and uses it to
